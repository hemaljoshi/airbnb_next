...
function Footer() {
  return (
    <footer className="bottom-0 grid-cols-4 space-y-5 divide-y divide-gray-400 divide-opacity-70 bg-gray-100 p-4 child:mx-auto child:max-w-5xl md:grid md:gap-3 md:space-y-0 md:divide-y-0">
      <div>
        <p className="flex-1 text-lg ">Support</p>
        <div className="grid grid-cols-3 space-y-2 text-xs capitalize child:cursor-pointer child-hover:underline md:block gap-x-3">
      ...
      <div>
        <p className="mt-4 flex-1 text-lg md:mt-0">Discover</p>
        <div className="grid grid-cols-3 space-y-2 text-xs capitalize child:cursor-pointer child-hover:underline md:block gap-x-3">
          <p className="mt-2">Trust & Safety</p>
          <p>Travel Credit</p>
          <p>Gift Cards</p>
          <p>Airbnb Citizen</p>
          <p>Business Travel</p>
